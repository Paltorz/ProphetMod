...
public abstract class MiracleCard extends AbstractCard{
    public static HashMap<String, Texture> imgMap;

    public static final String PORTRAIT_ENDING = "_p";

    public static Texture getPortraitImage(MiracleCard card) {
    ...
    public boolean miracleActive = false;

    public MiracleCard(String id, String name, String img, int cost, String rawDescription, AbstractCard.CardType type, AbstractCard.CardColor color, AbstractCard.CardRarity rarity, AbstractCard.CardTarget target, int cardPool) {
    ...
    public void loadCardImage(String img) {
        ...
        ReflectionHacks.setPrivateInherited(this, MiracleCard.class, "portrait", cardImg);
    }
}
